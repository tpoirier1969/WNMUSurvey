  ...
  "followUpModules": [
    {
      ...
      "label": "Local and Upper Peninsula programming",
      "time": "5–7 minutes"
    },
    {
      "id": "programming-ideas",
      "label": "Programming interests and ideas",
      "time": "5–7 minutes"
    },
    {
      "id": "online-viewing",
      "label": "Online viewing, PBS App, and Passport",
      "time": "4–6 minutes"
    },
    {
    ...
    {
      "id": "communication",
      "label": "Communication and finding programs",
      "time": "3–4 minutes"
    }
  ],
  "preproductionReset": {
    "previousSchema": "wnmu-viewer-questionnaire-v4",
    "previousDraftKey": "wnmuViewerSurveyDraft:v4",
    "previousResponseKey": "wnmuViewerSurveyResponses:v1",
    "retiredKeys": [
      "wnmuViewerSurveyDraft:v4",
      "wnmuViewerSurveyDraft:v1",
      "wnmuViewerSurveyResponses:v1"
    ],
    "note": "Prototype drafts and responses are intentionally cleared rather than migrated into schema v5."
  }
}
  };
