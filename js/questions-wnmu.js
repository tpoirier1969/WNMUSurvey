        ...
        questions: [
          {
            ...
            options: [
              { value: "local_pbs", label: "I knew WNMU-TV was my local PBS station" },
              { value: "station_not_pbs", label: "I knew it was a television station, but not that it was the local PBS station" },
              { value: "name_only", label: "I recognized the name but was not sure what it was" },
              { value: "not_heard", label: "I had not heard of WNMU-TV" }
            ]
          },
          {
            id: "viewer_status",
        ...
        questions: [
          {
            ...
            options: [
              ...
              { value: "cable_satellite", label: "Cable or satellite television" },
              { value: "wnmu_livestream", label: "WNMU-TV livestream" },
              { value: "pbs_app", label: "PBS App" },
              { value: "pbs_org", label: "PBS.org website" },
              { value: "pbs_passport", label: "PBS Passport through WNMU-TV" },
              { value: "youtube_tv", label: "YouTube TV" },
              { value: "youtube", label: "YouTube" },
              { value: "not_watched", label: "I have not watched WNMU-TV or PBS programming during the past 12 months" }
            ]
          },
          {
            ...
            options: [
              ...channels,
              { value: "none", label: "I was not aware of any of them" }
            ]
          },
          {
            id: "channels_received",
            type: "checkbox",
            when: { hasAnyMethod: ["antenna", "cable_satellite", "youtube_tv"] },
          ...
          },
          {
            ...
            options: [
              ...
              { value: "pbs_app", label: "PBS App" },
              { value: "pbs_passport", label: "PBS Passport through WNMU-TV" },
              { value: "pbs_kids_app", label: "PBS KIDS app" },
